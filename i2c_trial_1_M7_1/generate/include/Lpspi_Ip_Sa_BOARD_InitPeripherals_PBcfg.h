...
#ifndef LPSPI_IP_SAPBCFG_BOARD_INITPERIPHERALS_H
#define LPSPI_IP_SAPBCFG_BOARD_INITPERIPHERALS_H
...
#define LPSPI_IP_SA_BOARD_INITPERIPHERALS_AR_RELEASE_MINOR_VERSION_PBCFG         7
#define LPSPI_IP_SA_BOARD_INITPERIPHERALS_AR_RELEASE_REVISION_VERSION_PBCFG      0
#define LPSPI_IP_SA_BOARD_INITPERIPHERALS_SW_MAJOR_VERSION_PBCFG                 3
