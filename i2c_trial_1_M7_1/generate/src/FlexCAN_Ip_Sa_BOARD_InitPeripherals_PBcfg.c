...
#define FLEXCAN_IP_SA_AR_RELEASE_MINOR_VERSION_BOARD_INITPERIPHERALS_PBCFG_C      7
#define FLEXCAN_IP_SA_AR_RELEASE_REVISION_VERSION_BOARD_INITPERIPHERALS_PBCFG_C   0
#define FLEXCAN_IP_SA_SW_MAJOR_VERSION_BOARD_INITPERIPHERALS_PBCFG_C              3
...
Flexcan_Ip_StateType FlexCAN_BOARD_InitPeripherals_State0;
...
const Flexcan_Ip_ConfigType FlexCAN_Config0_BOARD_InitPeripherals  = {
